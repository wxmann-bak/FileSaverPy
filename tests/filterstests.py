...
class FiltersTests(unittest.TestCase):
    def setUp(self):
        self.src1 = objects.source(url='http://blah.com/img-1.jpg',
                                   timestamp=datetime(2017, 1, 5, 12, 15),
                                   ext='jpg',
                                   filename='img-1')

        self.src2 = objects.source(url='http://blah.com/img-2.jpg',
                                   timestamp=datetime(2017, 1, 5, 13, 15),
                                   ext='jpg',
                                   filename='img-2')

        self.src3 = objects.source(url='http://blah.com/img-3.gif',
                                   timestamp=datetime(2017, 1, 5, 12, 15),
                                   ext='gif',
                                   filename='img-3')
